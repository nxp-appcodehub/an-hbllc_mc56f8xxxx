...
/* ----------------------------------------------------------------------------
   -- XBARB_Init module documentation
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup XBARB_Init_module XBARB_Init module documentation
 * @{
 */
...
/*!
 * @}
 */ /* end of group XBARB_Init_module */
