...
/* ----------------------------------------------------------------------------
   -- XBARA_Init module documentation
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup XBARA_Init_module XBARA_Init module documentation
 * @{
 */
...
/*!
 * @}
 */ /* end of group XBARA_Init_module */
