...
MEMORY {
  ...
  .p_ramCode      (RWX): ORIGIN = 0x0000C000, LENGTH = 0x00004000 # pFlash subarea for ram-code storage
...
.data_in_p_flash_ROM : AT(__pROM_data_start)
  {
    ...
    * (.data)
    ...
    __pROM_code_start = __pROM_data_start + __data_size;
  ...
  .ramFunctions : AT(__pROM_code_start)
  {
    ...
    OBJECT(FPCLIB_Ctrl2P2Z_F16_FAsm,PCLIB_SDM.lib)
    ...
    * (codesInRam.text)
    ...
    __ramFunctions_LdAddr = __pROM_code_start + __data_size;
  } > .p_ramSpace
